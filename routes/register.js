...
router.post("/", [check('email', "Entrer un mail valid").isEmail(), check('name', "le nom n'est pas valid").isLength({min:1, max:undefined}), check('password', "au moin 5 caracter").isLength({ min: 5 })], (req, res) => {
